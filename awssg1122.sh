...
# 1. 下载并配置 awssg11.sh
echo "🚀 开始下载 /root/awssg11.sh ..."
curl -fsSL https://raw.githubusercontent.com/zjj10086/sssssss/refs/heads/main/awssg11.sh -o /root/awssg11.sh || {
...
curl -fsSL https://raw.githubusercontent.com/zjj10086/sssssss/refs/heads/main/awssg22.sh -o /root/awssg22.sh || {
